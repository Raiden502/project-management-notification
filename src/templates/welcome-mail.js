                                        ...
                                        <td style="padding: 40px 0px 0px;">
                                            ...
                                            <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                                                <div style="color: rgb(43, 21, 203); text-align: left;">
                                                    ...
                                                    <p style="padding-bottom: 16px">Welcome to tsmc a new organization is created by you. please use the admin credintials to login in ${name}</p>
